...
export function LandingHeader() {
    ...
    return (
        <header className="px-6 h-16 flex items-center justify-between border-b border-border/40 bg-background/80 backdrop-blur-md sticky top-0 z-50">
            ...
            {isMenuOpen && (
                <div className="absolute top-16 left-0 w-full h-[calc(100vh-4rem)] bg-white/80 backdrop-blur-md md:hidden flex flex-col items-center justify-center p-6 gap-8 animate-in slide-in-from-top-2 z-40">
                    <Link
                        href="#clinicians"
